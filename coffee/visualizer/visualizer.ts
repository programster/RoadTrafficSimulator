class Visualizer
{
    public function constructor()(this.world)
    {
        this.$canvas = $('#canvas');
    ...
    public function drawIntersection()(intersection, alpha)
    {
    ...
    public function drawSignals(road)
    {
    ...
    public function drawRoad(road, alpha)
    {
    ...
    public function updateCanvasSize()->
        if this.$canvas.attr('width') isnt $(window).width or
        this.$canvas.attr('height') isnt $(window).height
          this.$canvas.attr
            width: $(window).width()
            height: $(window).height()

    public function draw(time)
    {
        ...
        window.requestAnimationFrame this.draw if this.running
    }


      this.property 'running',
        get: -> this._running
        set: (running) ->
          if running then this.start() else this.stop()

    public function start()
    {
        unless this._running
          this._running = true
          this.draw()
    }
